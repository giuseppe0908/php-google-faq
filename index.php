      ...
      <nav>
        ...
        <div class="nav-bar-2">
          <ul>
            ...
            <li><a class="select" href="#">Domande frequenti</a></li>
          </ul>
        </div>
